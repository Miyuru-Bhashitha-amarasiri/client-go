...
type Reflector struct {
	...
	// stopHandle contains channels for stopping and observing to stoppage of the reflector
...
// RunWithStopOptions will exit when on of the stopOptions conditions is met.
